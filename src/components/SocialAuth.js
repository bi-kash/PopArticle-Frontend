...
function buildOauthUrl(provider) {
  ...
  // Based on the Postman collection, OAuth endpoints are GET requests without params
  // The backend handles the redirect flow internally
  return `${base}/api/v1/auth/oauth/${provider}`;
}

export default function SocialAuth() {
  // Opens OAuth in the current window (full redirect flow)
