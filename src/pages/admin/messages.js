...
export default function AdminMessagesPage() {
  ...
  const fetchMessages = async () => {
    setLoading(true);
    try {
      // No tenantId = platform-level messages (tenant_id IS NULL)
      const response = await messageService.getMessages(filters, null);
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            >
              ...
              <div>
                ...
                >
                  Messages sent from the main platform contact form (not
                  tenant-specific)
                </p>
              </div>
            </div>
              ...
              {selectedMessage ? (
                ...
                >
                  ...
                  <div style={{ padding: "1.5rem" }}>
                    ...
                    >
                      {selectedMessage.message || selectedMessage.body}
                    </div>
                ...
                >
                  ...
                  <p style={{ fontSize: "0.8125rem", marginTop: "0.25rem" }}>
                    Click on a message from the inbox to read it
                  </p>
                </div>
              )}
            </div>
